...
googleNet = addLayers(googleNet,tempLayers);
...
tempLayers = [
    ...
    fullyConnectedLayer(4,"Name","loss3-classifier","BiasLearnRateFactor",2)
...
googleNet = connectLayers(googleNet,"pool2-3x3_s2","inception_3a-5x5_reduce");
googleNet = connectLayers(googleNet,"pool2-3x3_s2","inception_3a-1x1");
googleNet = connectLayers(googleNet,"pool2-3x3_s2","inception_3a-pool");
googleNet = connectLayers(googleNet,"pool2-3x3_s2","inception_3a-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_3a-relu_5x5","inception_3a-output/in3");
googleNet = connectLayers(googleNet,"inception_3a-relu_3x3","inception_3a-output/in2");
googleNet = connectLayers(googleNet,"inception_3a-relu_1x1","inception_3a-output/in1");
googleNet = connectLayers(googleNet,"inception_3a-relu_pool_proj","inception_3a-output/in4");
googleNet = connectLayers(googleNet,"inception_3a-output","inception_3b-1x1");
googleNet = connectLayers(googleNet,"inception_3a-output","inception_3b-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_3a-output","inception_3b-5x5_reduce");
googleNet = connectLayers(googleNet,"inception_3a-output","inception_3b-pool");
googleNet = connectLayers(googleNet,"inception_3b-relu_1x1","inception_3b-output/in1");
googleNet = connectLayers(googleNet,"inception_3b-relu_3x3","inception_3b-output/in2");
googleNet = connectLayers(googleNet,"inception_3b-relu_5x5","inception_3b-output/in3");
googleNet = connectLayers(googleNet,"inception_3b-relu_pool_proj","inception_3b-output/in4");
googleNet = connectLayers(googleNet,"pool3-3x3_s2","inception_4a-3x3_reduce");
googleNet = connectLayers(googleNet,"pool3-3x3_s2","inception_4a-1x1");
googleNet = connectLayers(googleNet,"pool3-3x3_s2","inception_4a-5x5_reduce");
googleNet = connectLayers(googleNet,"pool3-3x3_s2","inception_4a-pool");
googleNet = connectLayers(googleNet,"inception_4a-relu_1x1","inception_4a-output/in1");
googleNet = connectLayers(googleNet,"inception_4a-relu_3x3","inception_4a-output/in2");
googleNet = connectLayers(googleNet,"inception_4a-relu_5x5","inception_4a-output/in3");
googleNet = connectLayers(googleNet,"inception_4a-relu_pool_proj","inception_4a-output/in4");
googleNet = connectLayers(googleNet,"inception_4a-output","inception_4b-1x1");
googleNet = connectLayers(googleNet,"inception_4a-output","inception_4b-5x5_reduce");
googleNet = connectLayers(googleNet,"inception_4a-output","inception_4b-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_4a-output","inception_4b-pool");
googleNet = connectLayers(googleNet,"inception_4b-relu_5x5","inception_4b-output/in3");
googleNet = connectLayers(googleNet,"inception_4b-relu_1x1","inception_4b-output/in1");
googleNet = connectLayers(googleNet,"inception_4b-relu_3x3","inception_4b-output/in2");
googleNet = connectLayers(googleNet,"inception_4b-relu_pool_proj","inception_4b-output/in4");
googleNet = connectLayers(googleNet,"inception_4b-output","inception_4c-5x5_reduce");
googleNet = connectLayers(googleNet,"inception_4b-output","inception_4c-1x1");
googleNet = connectLayers(googleNet,"inception_4b-output","inception_4c-pool");
googleNet = connectLayers(googleNet,"inception_4b-output","inception_4c-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_4c-relu_1x1","inception_4c-output/in1");
googleNet = connectLayers(googleNet,"inception_4c-relu_3x3","inception_4c-output/in2");
googleNet = connectLayers(googleNet,"inception_4c-relu_5x5","inception_4c-output/in3");
googleNet = connectLayers(googleNet,"inception_4c-relu_pool_proj","inception_4c-output/in4");
googleNet = connectLayers(googleNet,"inception_4c-output","inception_4d-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_4c-output","inception_4d-1x1");
googleNet = connectLayers(googleNet,"inception_4c-output","inception_4d-pool");
googleNet = connectLayers(googleNet,"inception_4c-output","inception_4d-5x5_reduce");
googleNet = connectLayers(googleNet,"inception_4d-relu_pool_proj","inception_4d-output/in4");
googleNet = connectLayers(googleNet,"inception_4d-relu_1x1","inception_4d-output/in1");
googleNet = connectLayers(googleNet,"inception_4d-relu_3x3","inception_4d-output/in2");
googleNet = connectLayers(googleNet,"inception_4d-relu_5x5","inception_4d-output/in3");
googleNet = connectLayers(googleNet,"inception_4d-output","inception_4e-1x1");
googleNet = connectLayers(googleNet,"inception_4d-output","inception_4e-pool");
googleNet = connectLayers(googleNet,"inception_4d-output","inception_4e-5x5_reduce");
googleNet = connectLayers(googleNet,"inception_4d-output","inception_4e-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_4e-relu_1x1","inception_4e-output/in1");
googleNet = connectLayers(googleNet,"inception_4e-relu_3x3","inception_4e-output/in2");
googleNet = connectLayers(googleNet,"inception_4e-relu_5x5","inception_4e-output/in3");
googleNet = connectLayers(googleNet,"inception_4e-relu_pool_proj","inception_4e-output/in4");
googleNet = connectLayers(googleNet,"pool4-3x3_s2","inception_5a-pool");
googleNet = connectLayers(googleNet,"pool4-3x3_s2","inception_5a-5x5_reduce");
googleNet = connectLayers(googleNet,"pool4-3x3_s2","inception_5a-1x1");
googleNet = connectLayers(googleNet,"pool4-3x3_s2","inception_5a-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_5a-relu_pool_proj","inception_5a-output/in4");
googleNet = connectLayers(googleNet,"inception_5a-relu_1x1","inception_5a-output/in1");
googleNet = connectLayers(googleNet,"inception_5a-relu_5x5","inception_5a-output/in3");
googleNet = connectLayers(googleNet,"inception_5a-relu_3x3","inception_5a-output/in2");
googleNet = connectLayers(googleNet,"inception_5a-output","inception_5b-pool");
googleNet = connectLayers(googleNet,"inception_5a-output","inception_5b-5x5_reduce");
googleNet = connectLayers(googleNet,"inception_5a-output","inception_5b-3x3_reduce");
googleNet = connectLayers(googleNet,"inception_5a-output","inception_5b-1x1");
googleNet = connectLayers(googleNet,"inception_5b-relu_3x3","inception_5b-output/in2");
googleNet = connectLayers(googleNet,"inception_5b-relu_5x5","inception_5b-output/in3");
googleNet = connectLayers(googleNet,"inception_5b-relu_pool_proj","inception_5b-output/in4");
googleNet = connectLayers(googleNet,"inception_5b-relu_1x1","inception_5b-output/in1");
