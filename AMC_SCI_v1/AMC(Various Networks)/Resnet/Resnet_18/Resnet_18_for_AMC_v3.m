...
tempLayers = [
    ...
    convolution2dLayer([1 7],64,"Name","conv1","BiasLearnRateFactor",0,"Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],64,"Name","res2a_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn2a_branch2a")
    reluLayer("Name","res2a_branch2a_relu")
    convolution2dLayer([1 3],64,"Name","res2a_branch2b","BiasLearnRateFactor",0,"Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],64,"Name","res2b_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn2b_branch2a")
    reluLayer("Name","res2b_branch2a_relu")
    convolution2dLayer([1 3],64,"Name","res2b_branch2b","BiasLearnRateFactor",0,"Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],128,"Name","res3a_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn3a_branch2a")
    reluLayer("Name","res3a_branch2a_relu")
    convolution2dLayer([1 3],128,"Name","res3a_branch2b","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn3a_branch2b")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],128,"Name","res3a_branch1","BiasLearnRateFactor",0)
...
tempLayers = [
    convolution2dLayer([1 3],128,"Name","res3b_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn3b_branch2a")
    reluLayer("Name","res3b_branch2a_relu")
    convolution2dLayer([1 3],128,"Name","res3b_branch2b","BiasLearnRateFactor",0,"Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],256,"Name","res4a_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn4a_branch2a")
    reluLayer("Name","res4a_branch2a_relu")
    convolution2dLayer([1 3],256,"Name","res4a_branch2b","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn4a_branch2b")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],256,"Name","res4a_branch1","BiasLearnRateFactor",0)
...
tempLayers = [
    convolution2dLayer([1 3],256,"Name","res4b_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn4b_branch2a")
    reluLayer("Name","res4b_branch2a_relu")
    convolution2dLayer([1 3],256,"Name","res4b_branch2b","BiasLearnRateFactor",0,"Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],512,"Name","res5a_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn5a_branch2a")
    reluLayer("Name","res5a_branch2a_relu")
    convolution2dLayer([1 3],512,"Name","res5a_branch2b","BiasLearnRateFactor",0,"Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],512,"Name","res5b_branch2a","BiasLearnRateFactor",0,"Padding","same")
    batchNormalizationLayer("Name","bn5b_branch2a")
    reluLayer("Name","res5b_branch2a_relu")
    convolution2dLayer([1 3],512,"Name","res5b_branch2b","BiasLearnRateFactor",0,"Padding","same")
