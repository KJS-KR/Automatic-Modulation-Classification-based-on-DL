...
tempLayers = [
    imageInputLayer([1 512 2],'Normalization','none',"Name","signal_input")
    convolution2dLayer([1 7],64,"Name","conv1","Padding","same")
...
tempLayers = [
    convolution2dLayer([1 3],128,"Name","res3a_branch2a","Padding","same","Stride",[1 2])
...
tempLayers = [
    convolution2dLayer([1 1],128,"Name","res3a_branch1","Padding","same","Stride",[1 2])
...
tempLayers = [
    convolution2dLayer([1 1],256,"Name","res4a_branch1","Padding","same","Stride",[1 2])
...
tempLayers = [
    convolution2dLayer([1 1],512,"Name","res5a_branch1","Padding","same","Stride",[1 2])
