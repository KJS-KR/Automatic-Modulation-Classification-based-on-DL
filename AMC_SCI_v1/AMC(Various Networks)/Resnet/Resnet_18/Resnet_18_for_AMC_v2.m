...
tempLayers = [
    ...
    convolution2dLayer([1 7],64,"Name","conv1","BiasLearnRateFactor",0,"Padding","same","Stride",[1 2])
...
tempLayers = [
    convolution2dLayer([1 3],128,"Name","res3a_branch2a","BiasLearnRateFactor",0,"Padding","same","Stride",[2 2])
