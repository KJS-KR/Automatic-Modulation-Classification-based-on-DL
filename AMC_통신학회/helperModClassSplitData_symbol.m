function [trainDS,validDS,testDS] = helperModClassSplitData_symbol(frameDS,splitPercentages,numFramesPerModType)
...
numFrames = numFramesPerModType*9/10;
...
for modType = 1:length(symbolTypes)
  rawIdx = find(rxLabels == symbolTypes(modType));
  numFrames = numFramesPerModType/numSymbolTypes*9/10;
  numFrames
