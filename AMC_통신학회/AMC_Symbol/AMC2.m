...
for SNR_num = 1:1:4
    for spf_num = 1:1:1
        for phase_num = 1:1:length(Phase)
            dataDirectory = fullfile("DataFiles", "AWGN", string(SNR(SNR_num)), string(spf(spf_num)), "QPSK_8PSK", string(Phase_degree(phase_num)));
