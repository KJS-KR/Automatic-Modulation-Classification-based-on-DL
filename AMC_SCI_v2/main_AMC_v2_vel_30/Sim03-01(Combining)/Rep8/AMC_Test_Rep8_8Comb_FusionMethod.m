...
for snrIdx = 9:length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        totalQpskSig(:, :, frameIdx) = softComQpskSig1 + softComQpskSig2 + softComQpskSig3 + softComQpskSig4;
        ...
        total16qamSig(:, :, frameIdx) = softCom16qamSig1 + softCom16qamSig2 + softCom16qamSig3 + softCom16qamSig4;
        ...
        total64qamSig(:, :, frameIdx) = softCom64qamSig1 + softCom64qamSig2 + softCom64qamSig3 + softCom64qamSig4;
        ...
        total256qamSig(:, :, frameIdx) = softCom256qamSig1 + softCom256qamSig2 + softCom256qamSig3 + softCom256qamSig4;
    end
