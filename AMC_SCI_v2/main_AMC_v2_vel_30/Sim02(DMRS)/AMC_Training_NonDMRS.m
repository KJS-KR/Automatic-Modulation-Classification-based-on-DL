...
%         imagesc(abs(tdlQpskSig))
        ...
        tdlQpskSig(tdlQpskSig==0) = []; % DMRS 삭제
        ...
        tdl16qamSig(tdl16qamSig==0) = []; % DMRS 삭제
        ...
        tdl64qamSig(tdl64qamSig==0) = []; % DMRS 삭제
        ...
        tdl256qamSig(tdl256qamSig==0) = []; % DMRS 삭제
...
%% Training network and processing time
    ...
    exportONNXNetwork(trainedNet, "NonDMRS_Network/" + snr(snrIdx) + "dB_AMC_Network.onnx")
end