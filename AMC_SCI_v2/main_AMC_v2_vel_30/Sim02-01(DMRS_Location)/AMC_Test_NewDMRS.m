...
symbolLocationType1         = [3, 10];
symbolLocationType2         = [1, 6, 11];
symbolLocationType3         = [1, 4, 7, 10];

dmrs.CustomSymbolSet        = symbolLocationType1;
...
%         imagesc(abs(tdlQpskSig))
        tdlQpskSig = reshape(tdlQpskSig(1:N_sc, 2:N_syms-1),[],1);
        ...
        tdl16qamSig = reshape(tdl16qamSig(1:N_sc, 2:N_syms-1),[],1);
        ...
        tdl64qamSig = reshape(tdl64qamSig(1:N_sc, 2:N_syms-1),[],1);
        ...
        tdl256qamSig = reshape(tdl256qamSig(1:N_sc, 2:N_syms-1),[],1);
...
%% Testing network and processing time
    ...
    trainedNet      = importONNXNetwork("NewDMRS_Network_Type1/" + snr(snrIdx) + "dB_AMC_network.onnx");
