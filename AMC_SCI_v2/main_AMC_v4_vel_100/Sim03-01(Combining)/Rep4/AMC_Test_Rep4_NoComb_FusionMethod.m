...
for snrIdx = 2:length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        repQpskSig = vertcat(awgnQpskSig{1}, awgnQpskSig{2}, awgnQpskSig{3}, awgnQpskSig{4});
        ...
        rep16qamSig = vertcat(awgn16qamSig{1}, awgn16qamSig{2}, awgn16qamSig{3}, awgn16qamSig{4});
        ...
        rep64qamSig = vertcat(awgn64qamSig{1}, awgn64qamSig{2}, awgn64qamSig{3}, awgn64qamSig{4});
        ...
        rep256qamSig = vertcat(awgn256qamSig{1}, awgn256qamSig{2}, awgn256qamSig{3}, awgn256qamSig{4});
...
%% 학습된 신경망을 통해 Fusion Method 시뮬레이션
        ...
        trainedNet      = importONNXNetwork("1Comb_Network_"+ vel +"/" + snr(snrIdx) + "dB_AMC_network.onnx");
