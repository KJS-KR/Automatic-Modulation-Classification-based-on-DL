...
for snrIdx = 1:length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        totalQpskSig(:, :, frameIdx) = vertcat(softComQpskSig1, softComQpskSig2);
        ...
        total16qamSig(:, :, frameIdx) = vertcat(softCom16qamSig1, softCom16qamSig2);
        ...
        total64qamSig(:, :, frameIdx) = vertcat(softCom64qamSig1, softCom64qamSig2);
        ...
        total256qamSig(:, :, frameIdx) = vertcat(softCom256qamSig1, softCom256qamSig2);
    end
