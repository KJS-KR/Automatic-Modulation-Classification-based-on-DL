...
for snrIdx = 1:length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        softComQpskSig = awgnQpskSig{1} + awgnQpskSig{2};
        ...
        softCom16qamSig = awgn16qamSig{1} + awgn16qamSig{2};
        ...
        softCom64qamSig = awgn64qamSig{1} + awgn64qamSig{2};
        ...
        softCom256qamSig = awgn256qamSig{1} + awgn256qamSig{2};
