...
for snrIdx = 1:length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        repQpskSig = vertcat(awgnQpskSig{1}, awgnQpskSig{2});
        ...
        rep16qamSig = vertcat(awgn16qamSig{1}, awgn16qamSig{2});
        ...
        rep64qamSig = vertcat(awgn64qamSig{1}, awgn64qamSig{2});
        ...
        rep256qamSig = vertcat(awgn256qamSig{1}, awgn256qamSig{2});
