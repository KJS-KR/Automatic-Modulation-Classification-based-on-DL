...
for snrIdx = 15:length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        softComQpskSig = cell2mat(awgnQpskSig);
        softComQpskSig = reshape(softComQpskSig, spf, comb);
        softComQpskSig = sum(softComQpskSig, 2);
        ...
        softCom16qamSig = cell2mat(awgn16qamSig);
        softCom16qamSig = reshape(softCom16qamSig, spf, comb);
        softCom16qamSig = sum(softCom16qamSig, 2);
        ...
        softCom64qamSig = cell2mat(awgn64qamSig);
        softCom64qamSig = reshape(softCom64qamSig, spf, comb);
        softCom64qamSig = sum(softCom64qamSig, 2);
        ...
        softCom256qamSig = cell2mat(awgn256qamSig);
        softCom256qamSig = reshape(softCom256qamSig, spf, comb);
        softCom256qamSig = sum(softCom256qamSig, 2);
...
%% Training network and processing time
    ...
    exportONNXNetwork(trainedNet, comb + "Comb_Network_"+ vel +"/" + snr(snrIdx) + "dB_AMC_Network.onnx")
end