...
for snrIdx = 12:12 %length(snr) 
    ...
    parfor frameIdx = 1:numFrame
        ...
        softComQpskSig3 = awgnQpskSig{5} + awgnQpskSig{6};
        softComQpskSig4 = awgnQpskSig{7} + awgnQpskSig{8};
        totalQpskSig(:, :, frameIdx) = vertcat(softComQpskSig1 + softComQpskSig2 + softComQpskSig3 + softComQpskSig4);
        ...
        softCom16qamSig3 = awgn16qamSig{5} + awgn16qamSig{6};
        softCom16qamSig4 = awgn16qamSig{7} + awgn16qamSig{8};
        total16qamSig(:, :, frameIdx) = vertcat(softCom16qamSig1 + softCom16qamSig2 + softCom16qamSig3 + softCom16qamSig4);
        ...
        softCom64qamSig3 = awgn64qamSig{5} + awgn64qamSig{6};
        softCom64qamSig4 = awgn64qamSig{7} + awgn64qamSig{8};
        total64qamSig(:, :, frameIdx) = vertcat(softCom64qamSig1 + softCom64qamSig2 + softCom64qamSig3 + softCom64qamSig4);
        ...
        softCom256qamSig3 = awgn256qamSig{5} + awgn256qamSig{6};
        softCom256qamSig4 = awgn256qamSig{7} + awgn256qamSig{8};
        total256qamSig(:, :, frameIdx) = vertcat(softCom256qamSig1 + softCom256qamSig2 + softCom256qamSig3 + softCom256qamSig4);
    end
...
%% 학습된 신경망을 통해 Fusion Method 시뮬레이션
        ...
        trainedNet      = importONNXNetwork("8Comb_Network_"+ vel +"/" + snr(snrIdx) + "dB_AMC_network.onnx");
