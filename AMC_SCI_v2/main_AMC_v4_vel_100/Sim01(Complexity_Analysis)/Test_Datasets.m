...
%         imagesc(abs(ResourceQpsk))
        ...
        figure;
        plot(real(awgn256qamSig), imag(awgn256qamSig), 'x');
        axis([-3 3 -3 3])
    end
...
% 
%     exportONNXNetwork(trainedNet, netTypes(selectNet) + "_Network/" + snr(snrIdx) + "dB_AMC_Network.onnx")
end
