...
for snrIdx = 1:numSnr
    ...
    parfor frameIdx = 1:numFrame
        ...
        for segIdx = 1:numSegment
            awgnQpskSig{segIdx} = awgn(modQpskSig, snr(snrIdx));
        end
        ...
        for segIdx = 1:numSegment
            awgn16qamSig{segIdx} = awgn(mod16qamSig, snr(snrIdx));
        end
        ...
        for segIdx = 1:numSegment
            awgn64qamSig{segIdx} = awgn(mod64qamSig, snr(snrIdx));
        end
        ...
        for segIdx = 1:numSegment
            awgn256qamSig{segIdx} = awgn(mod256qamSig, snr(snrIdx));
        end
