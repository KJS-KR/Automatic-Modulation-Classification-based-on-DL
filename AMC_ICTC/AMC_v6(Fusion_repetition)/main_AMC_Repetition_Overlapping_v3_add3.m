...
for snrIdx = 1:numSnr
    for frameIdx = 1:N_Frame
        ...
        % (1rep+2rep), (3rep+4rep)
        addSigBpsk(1:spf,:) = repSigBpsk(1:spf,:) + repSigBpsk(1+spf:spf*2) + repSigBpsk(1+spf*2:spf*3);
        addSigBpsk(1+spf:spf*2,:) = repSigBpsk(1+spf:spf*2) + repSigBpsk(1+spf*2:spf*3) + repSigBpsk(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSigQpsk(1:spf,:) = repSigQpsk(1:spf,:) + repSigQpsk(1+spf:spf*2) + repSigQpsk(1+spf*2:spf*3);
        addSigQpsk(1+spf:spf*2,:) = repSigQpsk(1+spf:spf*2) + repSigQpsk(1+spf*2:spf*3) + repSigQpsk(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSig8psk(1:spf,:) = repSig8psk(1:spf,:) + repSig8psk(1+spf:spf*2) + repSig8psk(1+spf*2:spf*3);
        addSig8psk(1+spf:spf*2,:) = repSig8psk(1+spf:spf*2) + repSig8psk(1+spf*2:spf*3) + repSig8psk(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSig16qam(1:spf,:) = repSig16qam(1:spf,:) + repSig16qam(1+spf:spf*2) + repSig16qam(1+spf*2:spf*3);
        addSig16qam(1+spf:spf*2,:) = repSig16qam(1+spf:spf*2) + repSig16qam(1+spf*2:spf*3) + repSig16qam(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSig32qam(1:spf,:) = repSig32qam(1:spf,:) + repSig32qam(1+spf:spf*2) + repSig32qam(1+spf*2:spf*3);
        addSig32qam(1+spf:spf*2,:) = repSig32qam(1+spf:spf*2) + repSig32qam(1+spf*2:spf*3) + repSig32qam(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSig64qam(1:spf,:) = repSig64qam(1:spf,:) + repSig64qam(1+spf:spf*2) + repSig64qam(1+spf*2:spf*3);
        addSig64qam(1+spf:spf*2,:) = repSig64qam(1+spf:spf*2) + repSig64qam(1+spf*2:spf*3) + repSig64qam(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSig4pam(1:spf,:) = repSig4pam(1:spf,:) + repSig4pam(1+spf:spf*2) + repSig4pam(1+spf*2:spf*3);
        addSig4pam(1+spf:spf*2,:) = repSig4pam(1+spf:spf*2) + repSig4pam(1+spf*2:spf*3) + repSig4pam(1+spf*3:spf*4);
        ...
        % (1rep+2rep), (3rep+4rep)
        addSig8pam(1:spf,:) = repSig8pam(1:spf,:) + repSig8pam(1+spf:spf*2) + repSig8pam(1+spf*2:spf*3);
        addSig8pam(1+spf:spf*2,:) = repSig8pam(1+spf:spf*2) + repSig8pam(1+spf*2:spf*3) + repSig8pam(1+spf*3:spf*4);
