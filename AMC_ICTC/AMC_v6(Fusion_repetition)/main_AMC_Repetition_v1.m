...
%% 학습된 신경망을 통한 결과
    ...
    averageTestAcc              = (totalTestAcc/numRepetition);
    ...
    averageSoftOutput               = (totalSoftOutput/numRepetition).';
