...
for snrIdx = 1:numSnr
    parfor frameIdx = 1:numFrame
        ...
        addNormSigQpks = addSigQpsk/2;
        totalSigQpsk(:, :, frameIdx) = addNormSigQpks;
        ...
        addNormSig16qam = addSig16qam/2;
        totalSig16qam(:, :, frameIdx) = addNormSig16qam;
        ...
        addNormSig64qam = addSig64qam/2;
        totalSig64qam(:, :, frameIdx) = addNormSig64qam;
        ...
        addNormSig256qam = addSig256qam/2;
        totalSig256qam(:, :, frameIdx) = addNormSig256qam;
    end
...
%% 레이어 설정 및 학습
    ...
    exportONNXNetwork(trainedNet, snr(snrIdx) + "dB_AMC_Network(Add2Norm).onnx")
end