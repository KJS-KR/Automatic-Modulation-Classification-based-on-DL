...
for snrIdx = 1:numSnr
    ...
    parfor frameIdx = 1:numFrame
        ...
        addSigQpsk = awgnQpskSig1 + awgnQpskSig2 + awgnQpskSig3 + awgnQpskSig4;
        ...
        addSig16qam = awgn16qamSig1 + awgn16qamSig2 + awgn16qamSig3 + awgn16qamSig4;
        ...
        addSig64qam = awgn64qamSig1 + awgn64qamSig2 + awgn64qamSig3 + awgn64qamSig4;
        ...
        addSig256qam = awgn256qamSig1 + awgn256qamSig2 + awgn256qamSig3 + awgn256qamSig4;
...
%% 레이어 설정 및 학습
    testPred = rxTestLabels;
        ...
        trainedNet      = importONNXNetwork("Network_v2/" + snr(snrIdx) + "dB_AMC_network(Add4).onnx");
