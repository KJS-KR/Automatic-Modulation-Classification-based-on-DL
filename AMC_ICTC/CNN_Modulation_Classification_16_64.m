...
for phase_16 = 1:1:1
    for phase_64 = 1:1:1
        ...
        transDelay = 50;
        make_dir = ['dataDirectory = fullfile("DataFiles", "PathDelay_0_AverageGain_0_16QAM_', num2str(phase_16*0),'_64QAM_', num2str(phase_64*0),'");'];
        eval(make_dir);
        ...
        if ~dataFilesExist
          ...
          for modType = 1:numModulationTypes
            ...
            modulator = helperModClassGetModulator_16_64(modulationTypes(modType), sps, fs, phase_16, phase(phase_64));
