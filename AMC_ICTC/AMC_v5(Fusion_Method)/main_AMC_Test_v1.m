...
for idx = 10:1:10 %numSnr
    ...
    testPred = rxValidLabels;

    trainedNet      = importONNXNetwork(snr(idx) + "dB_AMC_network.onnx");
    rxTestPred      = classify(trainedNet,rxValidFrames);
    ...
    testAccuracy    = mean(testPred == rxValidLabels);
