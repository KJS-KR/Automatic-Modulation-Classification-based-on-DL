...
for snrIdx = 1:numSnr
    ...
    parfor frameIdx = 1:numFrame
        ...
        repQpskSig = vertcat(awgnQpskSig1, awgnQpskSig2);
        ...
        rep16qamSig = vertcat(awgn16qamSig1, awgn16qamSig2);
        ...
        rep64qamSig = vertcat(awgn64qamSig1, awgn64qamSig2);
        ...
        rep256qamSig = vertcat(awgn256qamSig1, awgn256qamSig2);
...
%% 학습된 신경망을 통해 Fusion Method 시뮬레이션
        ...
        trainedNet      = importONNXNetwork("Network_v3/" + snr(snrIdx) + "dB_AMC_network.onnx");
